...
<body>
    ...
    <div id="student">
        ...
        <a href="<%=basePath %>StudentServlet?method=view&stu_id=1032">
            <figure>
                <img src="img/student/content1.jpg">
                <figcaption>
	                <h4>....</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>">
            <figure>
                <img src="img/student/content2.jpg">
                <figcaption>
	                <h4>....</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>">
            <figure>
                <img src="img/student/content3.jpg">
                <figcaption>
	                <h4>dafdsaf</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>">
            <figure>
                <img src="img/student/content4.jpg">
                <figcaption>
	                <h4>....</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>">
            <figure>
                <img src="img/student/content5.jpg">
                <figcaption>
	                <h4>....</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>StudentServlet?method=view&stu_id=1041">
            <figure>
                <img src="img/student/content6.jpg">
                <figcaption>
	                <h4>兔兔</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>StudentServlet?method=view&stu_id=1043">
            <figure>
                <img src="img/student/content7.jpg">
                <figcaption>
	                <h4>乐乐</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>">
            <figure>
                <img src="img/student/content8.jpg">
                <figcaption>
	                <h4>....</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath %>">
            <figure>
                <img src="img/student/content9.jpg">
                <figcaption>
	                <h4>....</h4>
	            </figcaption>
            </figure>
