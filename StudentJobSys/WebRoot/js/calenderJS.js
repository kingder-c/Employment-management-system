...
function HS_calender(){
	...
	for (i=1; i<=thisMonthEndDate; i++){ // Current Month's Date
		...
		if (now.getMonth()+1 <= 9)
		{
			monthString = "0"+(parseInt(now.getMonth())+1).toString();
		}
		else
		{
			monthString = (parseInt(now.getMonth())+1).toString();
		}
		if (i<=9)
		{
			dateString = "0"+i;
		...
		var todayString = now.getFullYear()+"-"+monthString+"-"+dateString;
		if(today == now.getFullYear()+"-"+now.getMonth()+"-"+i){
			lis += "<li><a href=javascript:void(0) class='today' onclick='_selectThisDay(this)' title='"+todayString+"'>"+i+"</a></li>";
		}else{
