...
<body>
   ...
   <div id="head_bottom">
            ...
            <dd id="student"><a href="student.jsp">学员展示</a></dd>
	            	...
	            	<c:choose>
                		<c:when test="${role.role_id == 20||role.role_id == 26||role.role_id == 28 }">
	                		<li><a href="UserServlet?method=tiaozhuan&URL=StudentServlet?method=view">个人信息</a></li>
	            			<li><a href="UserServlet?method=tiaozhuan&URL=find_student.jsp">查询学员</a></li>
	            			<li><a href="StudentServlet?method=view">学员查询</a></li>
            	...
            	<ul id="showcompany">
            		<c:choose>
                		<c:when test="${role.role_id == 24||role.role_id == 26||role.role_id == 28 }">
	                		<li><a href="UserServlet?method=tiaozhuan&URL=CompanyServlet?method=view">企业信息</a></li>
	            			<li><a href="UserServlet?method=tiaozhuan&URL=CompanytServlet?method=selectCompany">查询企业</a></li>
    ...
    <div id="teacher">
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1077">
            <figure>
                <img src="img/teacher/陈小亮.jpg">
                <figcaption>
	                <h4>陈小亮</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1081">
            <figure>
                <img src="img/teacher/翟萌.jpg">
                <figcaption>
	                <h4>翟萌</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1079">
            <figure>
                <img src="img/teacher/关娇.jpg">
                <figcaption>
	                <h4>关娇</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1067">
            <figure>
                <img src="img/teacher/郭志强.jpg">
                <figcaption>
	                <h4>郭志强</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1075">
            <figure>
                <img src="img/teacher/焦琳娜.jpg">
                <figcaption>
	                <h4>焦琳娜</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1085">
            <figure>
                <img src="img/teacher/李树峰.jpg">
                <figcaption>
	                <h4>李树峰</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1073">
            <figure>
                <img src="img/teacher/林杉.jpg">
                <figcaption>
	                <h4>林杉</h4>
	            </figcaption>
            </figure>
        ...
        <a href="<%=basePath%>TeacherServlet?method=view&tea_id=1087">
            <figure>
                <img src="img/teacher/申鹏亮.jpg">
                <figcaption>
	                <h4>申鹏亮</h4>
	            </figcaption>
            </figure>
