...
function IMGS(id,w,h,da,c){
  ...
  if(typeof c =="undefined"){
    this.c={bg:"#600",color:"#fff",cbg:"#eee",ccolor:"#600",bc:"#ccc",step:3000}
  }else{
    this.c=c;
  }
...
da.push({src:"img/1473127837.jpg",name:"第一张",link:""});
da.push({src:"img/1472811792.jpg",name:"第二张",link:""});
da.push({src:"img/1472811773.jpg",name:"第三张",link:""});
var c={
 bg:"#333",//右下数字背景颜色
 color:"#FFF",//右下数字颜色
 cbg:"#FFF",//右下当前数字背景颜色
