...
<body>
   ...
   <div id="head_bottom">
    ...
    <div id="course">
        ...
        <a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=24">
            <figure>
                <img src="img/course/content1.jpg">
            </figure>
        </a>

    	<a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=112">
            <figure>
                <img src="img/course/content2.jpg">
            </figure>
        </a>

        <a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=35">
            <figure>
                <img src="img/course/content3.jpg">
            </figure>
        </a>

    	<a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=114">
            <figure>
                <img src="img/course/content4.jpg">
            </figure>
        </a>


    	<a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=116">
            <figure>
                <img src="img/course/content5.jpg">
            </figure>
        </a>

   		<a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=118">
            <figure>
                <img src="img/course/content6.jpg">
            </figure>
        </a>

        <a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=120">
            <figure>
                <img src="img/course/content7.jpg">
            </figure>
        </a>

   		<a href="http://localhost:8080/g5_VisionEmploymentSys/CourseServlet?method=view&cou_id=122">
            <figure>
                <img src="img/course/content8.jpg">
            </figure>
        </a>
    </div>
