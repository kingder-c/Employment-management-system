	...
	<script language="Javascript">
            ...
            function saveImg(){
            	...
            	if (x == "" || y == "" || w == "" || h == "" || inputImg == "") {
            		...
            		var data2 ={"arg":cropbox};
            		
            		jQuery.get("ImgCutUploadServlet?method=uploadSmallImg",{"arg":cropbox},callbackfn({"arg":cropbox}));
            	}
            }
...
<body>
	...
	//ImgCutUploadServlet?method=uploadFile&pathParam=studentImg&picWidth=222&picHeight=305
	...
	<form id="cutImg" name="fileUpload" method="post">
			<div id="hidden2">
				<input type="hidden" size="4" id="x" name="x" value="${x }" />
				<input type="hidden" size="4" id="y" name="y" value="${y }" />
