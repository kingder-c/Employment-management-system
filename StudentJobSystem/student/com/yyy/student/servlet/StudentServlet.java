package com.yyy.student.servlet;
...
public class StudentServlet extends BaseRequestUtil {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if("getByStuId".equals(method)){
			try {
				this.getByStuId(request, response);
	...
	private void query(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String cla_starttime1 = getString(request, "cla_starttime1");
		String cla_starttime2 = getString(request, "cla_starttime2");
		String indexRole = getString(request, "indexRole");
		StudentView stuv = new StudentView();
		stuv.setStu_graduation(stu_graduation);
		stuv.setStu_name(stu_name);
		...
		int page = getInt(request, "pageIndex", 1);
		List stuvList = new ArrayList();//集合
		try {
			...
			if("com".equals(indexRole)){
				request.getRequestDispatcher("student/studentList4.jsp")
				.forward(request, response);
			}else{
	...
	private void getByStuId(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
		long stu_id = getLong(request, "stu_id");
		List select_stu_sex = service.getSelectData("性别");
		request.setAttribute("select_stu_sex", select_stu_sex);
		...
		StudentView stu = service.getById(stu_id);
		request.setAttribute("stu", stu);
		request.getRequestDispatcher("student/studentList3.jsp")
		.forward(request, response);
	}
	private void getSelectStudentName(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
		long stu_id = getLong(request, "stu_id");
